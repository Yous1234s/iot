...
<!--                          <li><a href="contact.jsp">Nous contacter</a></li>-->
                        ...
                        <li><a href="controleur?action=AjStation">Ajouter Station </a></li>
                        
                        <li><a  href="controleur?action=AjObjet" >Ajouter Objet</a></li>
                        <li><a href="controleur?action=ajUser">Ajouter Utilisateur</a></li>
                        <li><a  href="controleur?action=AjZone" >Ajouter Zone</a></li>
                        <li><a href="controleur?action=AjBat">Ajouter Batiment </a></li>
                        <li><a  href="controleur?action=AjLocalisation" >Ajouter Localisation</a></li>
                         <li><a  href="controleur?action=voirZone" >lister Zone</a></li>
                         <li><a  href="controleur?action=listeAbonne" >Lister Abonne</a></li>


                        
<!--                        <li><a  href="Authentification.jsp" >Mon Compte</a></li>-->
