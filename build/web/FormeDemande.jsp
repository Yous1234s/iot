...
<!--                        <div id="message">
                        ...
                        <input type="hidden" name="action" value="ajoutDemande"/>
...
<!--                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input class="form-control" type="text" name="tel2"   placeholder="Telephone" name="telephone" onkeypress='return event.charCode >=48 && event.charCode <=57' maxlength="7"  required>
                                </div>
