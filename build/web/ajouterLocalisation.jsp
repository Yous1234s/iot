...
<!--                        <div id="message">
                       ...
                       <input type="hidden" name="action" value="enrLocalisation"/> 
                        
                            <fieldset class="row-fluid">
                                
                               
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input  class="form-control" type="text" name="nomLoca"   placeholder="Nom Localisation"   required>
                                    
                                </div>
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input  class="form-control" type="text" name="typeLoca"   placeholder="Type Localisation"   required>
                                    
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <select name="idBatiment" class="selectpicker form-control" data-style="btn-white" placeholder="Choisir Batiment">
                                        <c:forEach var="bat" items="${listebatiment}">  
                                       <option value="${bat.idBatiment}">${bat.nomBatiment}</option>
                                       </c:forEach>
                                 </select></div>
<!--                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <select name="" class="selectpicker form-control" data-style="btn-white" placeholder="Choisir Zone">
