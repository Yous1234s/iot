                       ...
                       <input type="hidden" name="action" value="enrStation"/> 
                            ...
                            <fieldset class="row-fluid">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input  class="form-control" type="text" name="nomSta"   placeholder="Nom Station"   required>
                                    
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input  class="form-control" type="text" name="typeSta"   placeholder="Type Station"   required>
                                    
                                </div>
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input  class="form-control" type="text" name="connectivite"   placeholder="Connectivite"   required>
                                    
                                </div>
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input  class="form-control" type="text" name="alerte"   placeholder="Alerte"   required>
                                    
                                </div>
                                
                                
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <select name="idReseau" class="selectpicker form-control" data-style="btn-white" placeholder="Choisir Batiment">
                                    <option value=""> Choisir un Reseau</option>
                                        <c:forEach var="re" items="${listereseau}">  
                                       <option value="${re.idReseau}">${re.nomReseau}</option>
                                       </c:forEach>
                                 </select></div>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <ul class="footer-links hov">
                          <li><a href="#">Retour <span class="icon icon-arrow-right2"></span></a></li>
