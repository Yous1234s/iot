<%-- 
    Document   : ListeZone
    Created on : 6 sept. 2019, 03:19:01
    Author     : TOSHIBA
--%>
...
<!--      <img src="img/iot.png" style="width: 100%"/>      -->
    ...
    <header class="header header_style_01">
        ...
        <u>  <h1 aligne="center"> Liste des Zones:</h1></u>
       
       <table class="table table-bordered" border="2">
  <thead>
       <tr>
       <th colspan="2" scope="col">Identification Zone</th> 
       <th colspan="2" scope="col">Nom Zone </th>
       </tr>
  </thead>
  <tbody>
       <c:forEach var="zo" items="${listeZo}"> 
          
    <tr>
      <td colspan="2" scope="col">${zo.idZone}</td>
      <td colspan="2" scope="col">${zo.nom}</td>
