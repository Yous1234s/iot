...
<!--                        <div id="message">
                       ...
                       <input type="hidden" name="action" value="enrBatiment"/> 
                        
                            <fieldset class="row-fluid">
                                
                               
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input  class="form-control" type="text" name="nomBat"   placeholder="Nom Batiment"   required>
                                    
                                </div>
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <select name="idZone" type="integer" class="selectpicker form-control" data-style="btn-white" placeholder="Choisir Zone">
<!--                                     <option value=""> Zone</option>-->
                                     <c:forEach var="zon" items="${listeZone}">  
                                       <option value="${zon.idZone}">${zon.nom}</option>
                                       </c:forEach>
                                 </select>
