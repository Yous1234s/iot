<%-- 
    Document   : test
    Created on : 5 sept. 2019, 16:25:58
    Author     : TOSHIBA
--%>
...
<div class="tab">
 ...
 <tr>
        ...
        <tr>
            <th colspan="4" scope="col">Nom Medicament</th> 
            <th colspan="4" scope="col">Quantite</th>
            <th colspan="4" scope="col">Utilisation</th>
        ...
        <c:forEach var="lm" items="${listerMedicament}">
            <tr>
                ...
                <th colspan="4" scope="col">${lm.nomMedicament}</th> 
                <th colspan="4" scope="col">${lm.quantite}</th> 
                <th colspan="4" scope="col">${lm.utilisation}</th> 
